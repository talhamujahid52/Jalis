...
import AddResortWrapper from "./AddService.style";
import {
  HeadingWrapper,
  ...
  return (
    ...
    <form
      ...
      onSubmit={() => {
        ...
        alert("This is Add service Page");
      }}
    >
      <AddResortWrapper>
        <h1 style={{ margin: "0px", fontWeight: "bold" }}>Add a Service</h1>
        <p
          style={{
            margin: "0px",
            color: "#A5A5A5",
        ...
        <AddResortInputWrapper>
          <HeadingWrapper>Service Name</HeadingWrapper>
          <AddServiceInputWrapper
            required
            type="text"
            value={resortName}
